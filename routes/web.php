...
Route::get('/get-dates/{type}', [App\Http\Controllers\HomeController::class, 'getDates'])->name('get.dates');
Route::get('/get-mname/{type}', [App\Http\Controllers\HomeController::class, 'getMNames'])->name('get.m_names');
Route::get('/get-lname/{type}', [App\Http\Controllers\HomeController::class, 'getLNames'])->name('get.l_names');
...
Route::get('/get-region/{type}', [App\Http\Controllers\HomeController::class, 'getRegion'])->name('get.region');
Route::get('/get-provinces/{type}', [App\Http\Controllers\HomeController::class, 'getProvinces'])->name('get.province');
Route::get('/get-municipalities/{type}', [App\Http\Controllers\HomeController::class, 'getMunicipalities'])->name('get.municipalities');
...
Route::get('/release-facility/{id}', [App\Http\Controllers\FacilityController::class, 'releaseFacility'])->name('release.facility');
Route::post('/include/facility', [App\Http\Controllers\FacilityController::class, 'addFacility'])->name('include.facility');
...
Route::match(['get', 'post'], 'dv/create/save',  [App\Http\Controllers\DvController::class, 'createDvSave'])->name('dv.create.save');
...
Route::get('/patient/proponent/{fundsource_id}', [App\Http\Controllers\FundSourceController::class, 'forPatientFacilityCode'])->name('facility.patient_pro.code');
...
Route::get('budget/tracking/{fundsourceId}/{type}', [App\Http\Controllers\UtilizationController::class, 'trackingBudget'])->name('budget_util.tracking');
...
Route::get('fundsources/transfer/facility/{facility_id}',[App\Http\Controllers\FundSourceController::class, 'fetchFacility'])->name('facility_fundsource.get');
...
Route::get('/user-online', [App\Http\Controllers\UserController::class, 'users'])->name('users');
Route::get('/users/activation', [App\Http\Controllers\UserController::class, 'usersActivation'])->name('users.activate');
...
Route::get('/bills/tracking/{id}', [App\Http\Controllers\FacilityController::class, 'tracking'])->name('bills.tracking');
