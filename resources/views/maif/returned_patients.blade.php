                    ...
                    <form method="GET">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-sm btn-info set_width" type="submit"><img src="\maif\public\images\icons8_search_16.png">Search</button> 
                        ...
                        <div class="input-group">
                            ...
                            <button type="submit" id="gen_btn" style="background-color:teal; color:white; border-radius:0; width:94px" class="btn"><i class="typcn typcn-calendar-outline menu-icon"></i>Range</button>
                            <button id="delete_mul" style="color:white; border-radius:0; " class="btn btn-danger set_width"><i class="fas fa-trash" style="color:white;"></i>Delete</button>
                        </div>
                        ...
                        <tr>
                            ...
                            <th style="min-width:120px; text-align:center;">
                                <div style="display: flex; align-items: center; justify-content: center; gap: 8px;">
                                    ...
                                    <a href="{{ route('returned.patients', ['sort' => 'facility','order' => ($order == 'asc' ? 'desc' : 'asc')]) }}">⇅</a>
                                </div>
                            </th>
                            <th style="min-width:120px; text-align:center;">
                                <div style="display: flex; align-items: center; justify-content: center; gap: 8px;">
                                    <select class="form-control filter" style="display:none;" id="proponent_select" name="proponent_select" multiple></select>
                                    <a href="{{ route('returned.patients', ['sort' => 'proponent','order' => ($order == 'asc' ? 'desc' : 'asc')]) }}">⇅</a>
                                </div>
                            </th>
                            ...
                            <th style="min-width:130px; text-align:center;">
                                <div style="display: flex; align-items: center; justify-content: center; gap: 8px;">
                                    ...
                                    <a href="{{ route('returned.patients', ['sort' => 'province', 'order' => ($order == 'asc' ? 'desc' : 'asc')]) }}">⇅</a>
                                </div>
                            </th>
                            <th style="min-width:150px; text-align:center;">
                                <div style="display: flex; align-items: center; justify-content: center; gap: 8px;">
                                    ...
                                    <a href="{{ route('returned.patients', ['sort' => 'municipality', 'order' => ($order == 'asc' ? 'desc' : 'asc')]) }}">⇅</a>
                                </div>
                            </th>
                            <th style="min-width:150px; text-align:center;">
                                <div style="display: flex; align-items: center; justify-content: center; gap: 8px;">
                                    <select class="form-control filter" style="display:none;" id="barangay_select" name="barangay_select" multiple></select>
                                    <a href="{{ route('returned.patients', ['sort' => 'barangay', 'order' => ($order == 'asc' ? 'desc' : 'asc')]) }}">⇅</a>
                                </div>
                            </th>
                            ...
                            <th style="min-width:150px">
                                <div style="display: flex; align-items: center; justify-content: center; gap: 8px;">
                                    ...
                                    <a href="{{ route('returned.patients', ['sort' => 'encoded_by', 'order' => ($order == 'asc' ? 'desc' : 'asc')]) }}">⇅</a>
                                </div>
                            </th>
                        </tr>
                    </thead>
...
<script>
     $('#delete_mul').on('click', function (e) {
        e.preventDefault();
        e.stopPropagation();

        if (id_list.length === 0) {
            Swal.fire('No selection', 'Please select at least one patient.', 'warning');
            return;
        }

        Swal.fire({
            title: 'Delete Selected Patients?',
            text: `You are about to delete ${id_list.length} patient(s). This action cannot be undone.`,
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: 'returned-gl/delete-multiple',
                    type: 'POST',
                    data: {
                    ...
                    success: function () {
                        Swal.fire('Deleted!', 'Selected patients were deleted.', 'success');
                        location.reload();
                    },
                    error: function () {
