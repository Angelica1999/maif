...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
                ...
                <div class="input-group">
                    <form method="GET" action="">
                        <div class="input-group">
                            ...
                            <select name="data_type" class="form-control" style="width: 100px; border:1px solid green" onchange="this.form.submit()">
                                <option value="" {{ $type == 1 ? 'selected' :'' }}>ALL</option>
                                <option value="1" {{ $type == 1 ? 'selected' :'' }}>IN-PATIENT</option>
                                <option value="2" {{ $type == 2 ? 'selected' :'' }}>OUT-PATIENT</option>
                            </select>
                            <input class="date" type="month" name="date_selection" style="border:1px solid teal" value="{{ $date }}" onchange="this.form.submit()">
                            <button type="submit" value="excel" name="excel" class="btn btn-excel" style="background-color: teal; border-radius: 0px; color: white;">EXCEL</button>
            ...
            <h4 class="card-title">CONSOLIDATED ANNEX B</h4>
...
<script>
    ...
    $('.btn-excel').on('click', function(e){
        ...
        if(!$('.date').val()){
            Swal.fire({
                title: 'Error!',
                text: 'Please select the month and year for the consolidated Annex B report.',
                icon: 'error',
                timer: 2000,
            });
        } else {
