                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div style ="display:flex; justify-content:space-between;">
                                        ...
                                        <a href="{{ route('fur.facility_view', ['id' => $facility->facility_id]) }}" style="height:30px; background-color:#1D4646; color:white" type="button" class="btn btn-sm"><i class="fa fa-eye"></i> View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
