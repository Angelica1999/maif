...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">ANNEX B <span class="text-success">({{ $facility_name. ' - '. \Carbon\Carbon::create()->month($month)->format('F') .' '. $year }})</span></h4>
            ...
            <div class="pl-5 pr-5 mt-5" id ="pagination_links">
                <div class="alert alert-info" role="alert">
                    ...
                    <strong>Total number of Patients: {{ count($data ?? []) }}</strong>
                </div>
            </div>
        </div>
    </div>
