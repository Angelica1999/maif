                        ...
                        <tr style="text-align:left;" >
                            <td height=4% width =58%>
                                ...
                                <div>
                                    ...
                                    <input style="width:80px; height: 25px;" name="vat_val" value="{{($info->vat > 3)?$amount / 1.12 : $amount}}">
                                    <input name="vat_d" value="{{($info->vat > 3)? $amount / 1.12 * $info->vat / 100: $amount * $info->vat / 100}}" style="width:100px; height: 25px; font-size: 8pt" readonly>
                                </div><br>
                                <div padding-top:10px>
                                    ...
                                    <input style="margin-left:0px; width:80px; height: 25px;" name="ewt_val" value="{{($info->vat > 3)?$amount / 1.12 : $amount}}">
                                    <input name="ewt_d" value="{{($info->vat > 3)? $amount / 1.12 * $info->Ewt / 100: $amount * $info->Ewt / 100}}" style="width:100px; height: 25px; font-size: 8pt" readonly>
                                </div><br><br>
                                <div>
                            ...
                            <td style="width:14%; border-left: 0; vertical-align:bottom" class= "header" >
                                ...
                                <br><br><br><br><br>
                                <p>{{(($info->vat > 3)? $amount / 1.12 * $info->vat / 100: $amount * $info->vat / 100) + (($info->vat > 3)? $amount / 1.12 * $info->Ewt / 100: $amount * $info->Ewt / 100)}}</p>
                                <br><br><br><br><br>
                                ...
                                <p style="">{{$amount - ((($info->vat > 3)? $amount / 1.12 * $info->vat / 100: $amount * $info->vat / 100) + (($info->vat > 3)? $amount / 1.12 * $info->Ewt / 100: $amount * $info->Ewt / 100))}}</p>
                            </td>
                          </tr>
                    </table>
                    <table border="2" style="width: 100%;">
                    ...
                    <table border="2" style="width: 100%;" >
                        <tr class="header">
                          ...
                          <tr class="header">
                            ...
                            <br>
                              <span id="total_debit">{{$new_dv? $amount - $new_dv->accumulated: $amount}}</span><br>
                            ...
                            <td style="width:20%; border-left: 0 ; text-align:right; vertical-align:top" >
                              <br><br><br>
                              <span>{{(($info->vat > 3)? $amount / 1.12 * $info->vat / 100: $amount * $info->vat / 100) + (($info->vat > 3)? $amount / 1.12 * $info->Ewt / 100: $amount * $info->Ewt / 100)}}</span><br>
