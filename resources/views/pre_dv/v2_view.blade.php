        ...
        <div class="new-times-roman table-responsive">
          <div class="container-fluid">
                ...
                <div class="col-md-12">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td width="54%" style="border-left:none; border-right:none; line-height:1.4">
                            ...
                            <td width="23%" style="text-align: center; border-right:none"><img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/bagong_pilipinas.png'))) }}" width="40%" ></td>
                        </tr>
                    </table>
                    ...
                    <tr class="header">
                          ...
                          <tr class="header">
                              ...
                              <td width =38% style="text-align:center"><b>SAMUEL B. GLOVA, CPA</td>
                              <td height=30px width =15%>Printed Name</td>
            ...
            <div class="modal-footer" id="dv_footer"> 
                ...
                <a type="button" style="border-radius:0px; color:white" onclick="removePre()" class="btn btn-sm btn-danger"><i class="typcn typcn-close menu-icon"></i>Delete</a>
